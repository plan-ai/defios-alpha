...
export default function VoteActions({ title, action }: VoteActionsTypes) {
  return (
    <>
      <h4 className="mb-6 uppercase text-gray-100">{title}</h4>
            ...
            <div className="grid gap-4">
              <div className="flex items-start gap-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 font-medium hover:underline hover:opacity-90 focus:underline focus:opacity-90 text-gray-300"
                >
              ...
              <div className="flex items-start gap-1">
                ...
                <span className="word-break-all font-medium leading-relaxed text-gray-300">
                  {item.inputs}
                </span>
              </div>
            </div>
