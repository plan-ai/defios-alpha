...
export default function RevealContent({
  ...
  return (
    <div className={className}>
      ...
      {!showContent && (
        <div className="before:content-[' '] relative from-white from-light-dark pt-3 before:absolute before:-top-8 before:block before:h-8 before:w-full before:bg-gradient-to-t">
          <Button
            size="mini"
            shape="rounded"
            // variant="ghost"
