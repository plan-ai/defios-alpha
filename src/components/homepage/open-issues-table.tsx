  ...
  return (
    <div className="mx-auto w-full">
      <div className="mb-3 flex flex-col rounded-xl border-b-2 border-gray-500 bg-light-dark shadow-card">
        <div className="flex w-full items-center py-3 px-6 text-base uppercase text-gray-300 xl:py-3.5 xl:text-lg 2xl:text-xl 3xl:py-4">
          Open Issues For You
        </div>
        <div className="grid grid-cols-5 items-center gap-6 border-t border-dashed border-gray-600 text-2xs text-gray-300 xl:text-xs 2xl:text-sm uppercase">
