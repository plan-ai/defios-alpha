    ...
    <>
      ...
      <section className="mx-auto w-full max-w-[1160px] text-sm">
            ...
            <div>
              ...
              <p className="leading-[1.8] text-gray-400">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-gray-100 underline transition-opacity duration-200 hover:no-underline hover:opacity-90"
                >
        ...
        <div className="mb-6 rounded-lg bg-light-dark p-5 shadow-card transition-shadow duration-200 hover:shadow-large xs:p-6 xs:pb-8">
          <h3 className="mb-2 font-medium text-gray-100 xl:text-lg">Actions</h3>
        ...
        <div className="mb-6 rounded-lg bg-light-dark p-5 shadow-card transition-shadow duration-200 hover:shadow-large xs:p-6 xs:pb-8">
          <h3 className="mb-2 font-medium text-gray-100 xl:text-lg">Title</h3>
          <p className="mb-5 leading-[1.8] text-gray-300">
