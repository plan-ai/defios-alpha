  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-lg text-sm">
        ...
        <div className="mt-6 rounded-lg p-4 shadow-card bg-light-dark sm:p-6">
          <div className="rounded-lg border border-solid border-gray-700 bg-dark">
            ...
            <AnimatePresence initial={false}>
              {isExpand && (
                ...
                >
                  <div className="border-t border-dashed p-4 border-gray-700 sm:p-6">
                    ...
                    <Button
                      ...
                      fullWidth={true}
                      color="gray"
                      className="mt-6 uppercase bg-gray-800"
                    >
                      Remove
                    </Button>
                  </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4">
            ...
            <Button
              ...
              fullWidth={true}
              color="gray"
              className="uppercase bg-gray-800"
            >
              Import
            </Button>
          </div>
